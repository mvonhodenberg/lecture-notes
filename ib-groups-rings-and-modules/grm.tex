...
\end{corollary}
\begin{proof}
      If $G \cong C_{d_1 }\times C_{d_2 }\times \ldots C_{d_t}$ with $d_1 | d_2 | \ldots | d_t$, then every $g \in G$ has order dividing $d_{t}$, and $h \in C_{d_t}$ of order $d_t$, then $(1,\ldots ,h)\in G$ has order $d_t$. Thus $G$ has exponent $d_t$.
\end{proof}
\end{document}