...
\begin{proof}
      ...
      Take $e \neq \sigma \in N$ and write $\sigma$ in its disjoint cycle decomposition. We have three cases: 
      \begin{enumerate}
           ...
           .\] Note $\tau$ gets cancelled as it fixes 1 to $r$. Therefore $N$ contains a 3-cycle and we are done. 
          ...
          .\] Then we are back to Case 1, so we are done.
